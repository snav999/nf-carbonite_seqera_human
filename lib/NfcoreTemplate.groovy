...
class NfcoreTemplate {
    ...
    public static String logo(workflow, monochrome_logs) {
        ...
        String.format(
            """\n
            ${colors.bblue}  ______     ___      .______      .______     ______   .__   __.  __  .___________. _______ ${colors.reset}
            ${colors.bblue} /      |   /   \\     |   _  \\     |   _  \\   /  __  \\  |  \\ |  | |  | |           ||   ____|${colors.reset}
            ${colors.bblue}|  ,----\'  /  ^  \\    |  |_)  |    |  |_)  | |  |  |  | |   \\|  | |  | `---|  |----`|  |__   ${colors.reset}
            ${colors.bblue}|  |      /  /_\\  \\   |      /     |   _  <  |  |  |  | |  . `  | |  |     |  |     |   __|  ${colors.reset}
            ${colors.bblue}|  `----./  _____  \\  |  |\\  \\----.|  |_)  | |  `--\'  | |  |\\   | |  |     |  |     |  |____ ${colors.reset}
            ${colors.bblue} \\______/__/     \\__\\ | _| `._____||______/   \\______/  |__| \\__| |__|     |__|     |_______|${colors.reset}
            ${colors.bblue}                                                                                             ${colors.reset}
